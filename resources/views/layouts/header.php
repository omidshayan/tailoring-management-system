          ...
          <?php if ($this->hasAccess('general')): ?>
            <li class="sidebar-menu ri-dashboard-line sidebar-menu-item has-dropdown">
              ...
              <ul class="sidebar-dropdown-menu">
                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('add-employee') ?>">
                    <li class="sidebar-dropdown-menu-item">ثبت کاربر جدید</li>
                  </a>
                <?php endif; ?>

                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('employees') ?>">
                    <li class="sidebar-dropdown-menu-item">نمایش کاربران</li>
                  </a>
                <?php endif; ?>
              </ul>
            </li>
          ...
          <?php if ($this->hasAccess('general')): ?>
            <li class="sidebar-menu ri-dashboard-line sidebar-menu-item has-dropdown">
              ...
              <ul class="sidebar-dropdown-menu">
                <?php if ($this->hasAccess('general')): ?>
                  <a href="<?= url('add-user') ?>">
                    <li class="sidebar-dropdown-menu-item">ثبت مشتری</li>
                  </a>
                <?php endif; ?>
