    ...
    <div class="box-container mt20">
        <table class="fl-table">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="color-orange <?= ($expense['state'] == 1) ? '' : 'color-red' ?>"><?= $number ?></td>
                        <td><?= ($expense['title_expenses']) ? $expense['title_expenses'] : '- - -' ?></td>
                        <td><?= $expense['category'] ?></td>

                        <td>
                            <?= number_format(intval($expense['amount'])) ?>
                            <?= $expense['amount'] != null ? '<span class="fs11">افغانی</span>' : '' ?>
                        </td>
