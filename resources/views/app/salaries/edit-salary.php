    <?php
    $title = 'ویرایش معاش: ' . $item['employee_name'];
                    ...
                    <div class="inputs d-flex">
                        <div class="one">
                            ...
                            <select name="employee_id" class="checkSelect">
                                <option disabled>کارمند را انتخاب نمایید</option>
                        ...
                        <div class="one">
                            ...
                            <input type="number" class="checkInput" value="<?= $item['paid_amount'] ?>" id="phone" name="paid_amount" placeholder="مبلغ پرداختی معاش را وارد نمایید" />
                        </div>
                    </div>
                    <div class="inputs d-flex">
                        <!-- <div class="one">
                        ...
                        <div class="one">
                            ...
                            <textarea name="description" placeholder="توضیحات را وارد نمایید"><?= $item['description'] ?></textarea>
                        </div>
                    </div>
