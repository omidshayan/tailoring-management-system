...
<!-- Start content -->
<div class="content">
    <div class="content-title"> مدیریت بخش کمپانی‌ها
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="company-store" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام کمپانی‌ <?= _star ?> </div>
                        <input type="text" name="company_name" class="checkInput" value="<?= old('name') ?>" placeholder="نام نام کمپانی را وارد نمایید" autocomplete="off" />
                    </div>
                    <div class="one">
