...
<div class="content">
    ...
    <div class="box-container">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= url('clothes-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($models) ?></div>
            <?php
            if (count($models) == null) { ?>
