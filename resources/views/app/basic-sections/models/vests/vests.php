...
<div class="content">
    ...
    <div class="box-container">
        <div class="insert">
            <form id="myForm" action="<?= url('vest-store') ?>" method="POST">
                <div class="inputs d-flex">
                    <div class="one">
                        <div class="label-form mb5 fs14">نام مدل <?= _star ?> </div>
                        <input type="text" name="vest_model" class="checkInput" value="<?= old('vest_models') ?>" placeholder="نام  مدل را وارد نمایید" autocomplete="off" autofocus />
                    </div>
                </div>
    ...
    <!-- show models -->
    <div class="box-container">
        <div class="mb10 fs14"> مدل‌های ثبت شده</div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $item['vest_model'] ?></td>
                        <td>
                            <a href="<?= url('edit-vest/' . $item['id']) ?>" class="color-orange">
                        ...
                        <td>
                            <a href="<?= url('vest-details/' . $item['id']) ?>">
        ...
        <div class="flex-justify-align mt20 paginate-section">
            <div class="table-info fs12">تعداد کل: <?= count($vests) ?></div>
            <?php
            if (count($vests) == null) { ?>
